#!/usr/bin/env python3
"""
SAMA Optimization Runner - Best Approach

This uses SAMA's singleton pattern without modifying Input_Data.py file.
...
def main():
    parser = argparse.ArgumentParser(
        description='Run SAMA optimization with wizard-configured parameters'
    )
    parser.add_argument(
        '--algorithm', '-a',
        type=str,
    ...
    parser.add_argument(
        '--config', '-c',
        type=str,
        default='sama_config_COMPLETE_HYBRID.yaml',
        help='Path to configuration YAML file (default: sama_config_COMPLETE_HYBRID.yaml)'
    )
    ...
    print("""
╔═══════════════════════════════════════════════════════════════════════════╗
║         SAMA Optimization with Wizard Configuration (Runtime)             ║
╚═══════════════════════════════════════════════════════════════════════════╝
""")
    ...
    if not config_path.exists():
        ...
        print("  python sama/sama/cli/sama_wizard_1_load_weather.py")
        print("  python sama/sama/cli/sama_wizard_2_rate_structures.py")
        print("  python sama/sama/cli/sama_wizard_3_MASTER.py")
        sys.exit(1)
