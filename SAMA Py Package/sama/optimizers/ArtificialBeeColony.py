...
# Problem Definition
from sama.core.Fitness import fitness as cost_function
...
class ImprovedArtificialBeeColony:
    ...
    def optimize(self):
        ...
        plt.tight_layout()
        import os
        os.makedirs('sama_outputs', exist_ok=True)
        plt.savefig('sama_outputs/Optimization.png', dpi=300)
        print("✓ Saved: sama_outputs/Optimization.png")
