...
from samapy.utilities.daysInMonth import daysInMonth
from samapy import get_content_path
import os
os.makedirs('samapy_inputs', exist_ok=True)
...
class Input_Data:
    def __init__(self):
        ...
        self.VarMin = np.array([0, 0, 0, 0, 0]) # Lower bound of variables
        self.VarMax = np.array([60, 60, 60, 20, 60]) # Upper bound of variables
        ...
        if load_type == 1:
            path_Eload = get_content_path('Eload.csv')
            ...
            from samapy.utilities.dataextender import dataextender
            ...
            from samapy.utilities.generic_load import generic_load
            ...
            self.path_Eload_daily = get_content_path('Eload_daily.csv')
        ...
        if load_previous_year_type == 1:
            ...
            path_Eload_Previous = get_content_path('Eload_previousyear.csv')
        ...
        if Tload_type == 1:
            data_2 = pd.read_excel(get_content_path('house_load.xlsx'))
        ...
        weather_url = get_content_path('METEO.csv')
        ...
        if G_type == 1:
            ...
            from samapy.utilities.sam_monofacial_poa import runSimulation
            ...
            self.path_G = get_content_path('Irradiance.csv')
        ...
        if T_type == 1:
            ...
            self.path_T = get_content_path('Temperature.csv')
        ...
        if WS_type == 1:
            ...
            self.path_WS = get_content_path('WSPEED.csv')
        ...
        self.available_roof_surface = 40  # available roof space for solar in m2
        ...
        self.HP = 1
        self.HP_brand = 'Goodman' #Goodman or Bosch
        ...
        #df.to_csv('samapy_inputs/Inputs.csv', index=False)
        ...
        # Economic Parameters
        self.n_ir_rate = 2.75            # Nominal discount rate
        ...
        if Grid_escalation_projection == 1:
            self.Grid_escalation_rate = np.full(25, 2) # Yearly escalation flat rate in grid electricity prices
        else:
        ...
        if self.rateStructure_NG == 1:  # Flat rate
            ...
            from samapy.pricing.calcMonthlyTieredRate4 import calcMonthlyTieredRate4
