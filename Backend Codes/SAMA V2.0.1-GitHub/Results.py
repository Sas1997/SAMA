...
def Gen_Results(X):
    ...
    from EMS_HP import calculate_hp_grid_allocation, calculate_hp_energy_sources_economic
    ...
    # Print comparison
    print_comparison(comparison, show_plot=True, save_path='output/figs/electricity_comparison.png')
    ...
    if HP > 0:
        ...
        # Create all plots
        plot_ambient_conditions(T, P, save_path='output/figs/hp_ambient_conditions.png')
        plot_heating_performance(T, Hload, power_hp_heating, COP_hp_heating,
                                 save_path='output/figs/hp_heating_performance.png')
        plot_cooling_performance(T, Cload, power_hp_cooling, COP_hp_cooling,
                                 save_path='output/figs/hp_cooling_performance.png')
        plot_cop_vs_temperature(T, Hload, Cload, COP_hp_heating, COP_hp_cooling,
                                save_path='output/figs/hp_cop_vs_temp.png')
        plot_monthly_summary(T, Hload, Cload, power_hp_heating, power_hp_cooling,
                             COP_hp_heating, COP_hp_cooling, save_path='output/figs/hp_monthly_summary.png')
