...
class parameter():
    def __init__(self, Eload, G, T, Vw):
        ...
        self.DG = 0 # Type of system (1: included, 0=not included)
        self.Bat = 0 # Type of system (1: included, 0=not included)
        self.Grid = 1
        ...
        self.Cbuy = self.calcTouCbuy(daysInMonth,months, holidays)
        self.Csell = 0.1
